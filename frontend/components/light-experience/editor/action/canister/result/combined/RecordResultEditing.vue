...
import { RecordCandidType } from '@mora-light/core/types/candid';
...
const props = defineProps({
    ...
    result: {
        type: Object as PropType<CanisterActionResultRecord>,
        required: true,
    },
});
...
<template>
    <div class="record-result-editing-content">
        <div class="main-type">
            <!-- <span class="type">

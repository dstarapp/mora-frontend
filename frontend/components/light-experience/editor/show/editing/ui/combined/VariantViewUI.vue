...
<template>
    <div class="variant-view-ui">
        ...
        <!-- <div class="item">
            ...
            <div class="tab-switch">
                ...
                <span
                    ...
                    :class="{ current: flexDirection === 'column' }"
                >
        ...
        <template v-if="subitemDialog">
            <ViewUIDialogVue :show="subitemDialog" :hasKey="true" :keyName="current!.key" :view="current!.view"
                :excludes="[
                'TableView',
                'VecView',
                'OptView',
